...
if ($_GET && isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM products WHERE $filter LIKE '%$search%' ";
    $customers = mysqli_query($connection, $query);
}
  ...
  <form class="d-flex mx-auto mt-4 align-items-center" role="search" style="width:50%;" onsubmit="return validateFilter()">
    <div class="dropdown me-2">
      ...
      <ul class="dropdown-menu" aria-labelledby="filterDropdown">
        ...
        <li><a class="dropdown-item" data-value="category">Category</a></li>
        <li><a class="dropdown-item" data-value="price">Price</a></li>
      </ul>
...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">Products Table</h1>
        ...
        <tbody>
            ...
            foreach ($customers as $customer) {
                echo "<tr>
                        ...
                        <td><a class='btn btn-danger' href='delete.php?id={$customer['ID']}' onclick='return confirm(\"Are you sure you want to delete this product?\")'>Delete</a></td>
                      </tr>";
            }
            ?>
        </tbody>
