...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($connection, $updateQuery)) {
        echo "<div class='alert alert-success text-center'>Admin updated successfully.</div>";
    } else {
        echo "<div class='alert alert-danger text-center'>Error: " . mysqli_error($connection) . "</div>";
    }
}

$customerQuery = mysqli_query($connection, "SELECT * FROM admins WHERE ID = $Id");
    ...
    <form action="" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="number" name="employeeId" class="form-control" value="<?= $customer['employeeId']; ?>" required>
            </div>
            <div class="col-md-6">
